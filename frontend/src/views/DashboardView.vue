      ...
      <div v-if="store.data.financial_by_model" class="card fin-chart-card">
        ...
        <div class="income-chart-scroll" style="margin-top:0.5rem">
          <svg v-if="finModelChart.hasData"
            ...
            <!-- Grid lines -->
            <g v-for="(t, ti) in finModelChart.ticks" :key="'ft-' + ti">
            ...
            <!-- Series lines -->
            <g v-for="s in finSeries" :key="'fs-' + s.key">
              ...
              <g v-if="finSeriesVisible[s.key]" v-for="(p, pi) in finModelChart.pts" :key="'fd-' + pi">
            ...
            <!-- X-axis labels -->
            <text v-for="(p, pi) in finModelChart.pts" :key="'fxl-' + pi"
            ...
            <!-- Legend -->
            <g v-for="(s, si) in finSeries.filter(s => finSeriesVisible[s.key])" :key="'fleg-' + si">
              <line
      ...
      <div class="bento-grid">
        ...
        <div class="bento-poverty card">
          ...
          <svg viewBox="0 0 420 165" class="poverty-area-svg" aria-label="Area chart of poverty distribution by level">
            <defs>
              <linearGradient id="povAreaGrad" x1="0" y1="0" x2="0" y2="1">
            ...
            <!-- Area fill -->
            <path :d="overallAreaChart.areaPath" fill="url(#povAreaGrad)"/>
            <!-- Smooth line -->
